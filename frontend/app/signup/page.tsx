// OmniAI - Page d'inscription — Gradient Modern
'use client'
          ...
          <div className="relative glass-card p-8">
            ...
            <div className="space-y-3 mb-6">
              ...
              >
                ...
                <span className="text-sm font-medium text-gray-300">S&apos;inscrire avec Google</span>
              </button>
              ...
              >
                ...
                <span className="text-sm font-medium text-gray-300">S&apos;inscrire avec GitHub</span>
              </button>
            </div>
